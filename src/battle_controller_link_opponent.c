...
static u32 CopyLinkOpponentMonData(u8 monId, u8 *dst)
{
    ...
    case REQUEST_ALL_BATTLE:
        ...
        battleMon.learnedAbility = GetMonData(&gEnemyParty[monId], MON_DATA_LEARNED_ABILITY);
        battleMon.learnedType = GetMonData(&gEnemyParty[monId], MON_DATA_LEARNED_TYPE);
